    ...
    return (
        <div style={{ margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", maxWidth: "850px" }}>
            <div style={{ marginLeft: "10px", marginTop: "10px" }}>
                ...
                <Image title={tooltip} onClick={changeEngine} style={{ marginLeft: "90px" }} alt="settings" width={33} height={33} src={translateEngine === "google" ? "/googletran.png" : "/openai.png"} />
            </div>
